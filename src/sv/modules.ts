 ...
 * .gitmodules) удаляются только при allowRemove — partial-резолюция
 * после force не должна сносить сабмодули, не попавшие в неё из-за
 * ошибки. Возвращает true, если рабочая копия изменилась.
 */
